<x-app-layout>
    <div class="lg:w-2/4 mx-auto py-8 px-6 bg-white rounded-xl mt-5">
        ...
        <div class="mb-6">
            <form action="{{route('todo.store')}}" class="flex flex-col space-y-4" method="POST">
                ...
                <textarea name="desc" placeholder="The todo description"
                          class="py-3 px-4 bg-gray-100 rounded-xl"></textarea>

                <button class="w-28 py-4 px-8 bg-green-500 text-white rounded-xl">Ekle</button>
            </form>
        </div>
